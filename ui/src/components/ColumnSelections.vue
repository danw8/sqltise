    ...
    <div class="column-selections">
        ...
        <div class="columns" v-for="(column, index) in column_selections.value" :key="index">
            <select v-model="column.column" class="column-select">
                <option v-for="(option, index) in columns" :key="index">{{option}}</option>
            </select>
            ...
            <select v-model="column.statement" class="column-select">
                <option v-for="(option, index) in statements.value" :key="index">{{option.name}} - ({{option.table}})</option>
            </select>
