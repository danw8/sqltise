...
export function context_run(a: number, b: number, c: number): number;
export function __wbgtest_console_log(a: number, b: number): void;
export function __wbgtest_console_error(a: number, b: number): void;
