...
export function generate_file(arg0, arg1, arg2, arg3) {
    ...
    const len0 = WASM_VECTOR_LEN;
    try {
        return takeObject(wasm.generate_file(ptr0, len0, addHeapObject(arg1), addHeapObject(arg2), arg3));
...
export function __wbg_forEach_7796ea23499aa552(arg0, arg1, arg2) {
    ...
    cbarg1.f = wasm.__wbg_function_table.get(189);
    cbarg1.a = arg1;
    cbarg1.b = arg2;
    try {
...
export function __wbg_new_bdd94b8735e4f66d(arg0, arg1) {
    ...
    cbarg0.f = wasm.__wbg_function_table.get(197);
    cbarg0.a = arg0;
    cbarg0.b = arg1;
    try {
...
export function __wbindgen_closure_wrapper584(a, b, _ignored) {
